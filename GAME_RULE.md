...
- **8단계**: 0.3초
- **9단계**: 0.2초
- **10단계 이상**: 0.1초까지 감소 (최소 제한 시간, 극한 난이도)

> 인간의 평균 반응 속도는 0.2~0.3초입니다. 포즈 인식 및 포즈 전환 시간을 고려하면
> 0.5초 이하부터는 매우 어렵고, 0.2초 이하는 거의 불가능에 가깝습니다.

### 타이밍
- **명령 표시 시간**: TTS 음성 출력 (약 1초)
- **제한 시간**: TTS 발화 종료 후부터 단계별 설정값만큼 카운트
- **다음 명령까지 대기 시간**: 제한 시간의 절반 (동적, 단계가 높아질수록 짧아짐)
  - 1단계 (1.0초): 0.5초 대기
  - 5단계 (0.6초): 0.3초 대기
  - 10단계 (0.1초): 0.05초 대기
...
| 단계 범위 | 난이도 | 제한 시간 | 대기 시간 | 설명 |
|---------|-------|---------|---------|------|
| 1-2단계 | 쉬움 | 1.0~0.9초 | 0.5~0.45초 | 여유있는 반응 시간 |
| 3-5단계 | 보통 | 0.8~0.6초 | 0.4~0.3초 | 빠른 반응 필요 |
| 6-8단계 | 어려움 | 0.5~0.3초 | 0.25~0.15초 | 매우 빠른 반응 필요 |
| 9단계 이상 | 극한 | 0.2~0.1초 | 0.1~0.05초 | 인간 반응 속도 한계 도전 |
...
### 4. 게임이 너무 빠르게 느껴질 때
- **원인**: 높은 단계에서 0.1초 단위 극한 난이도
- **설명**: 이것이 의도된 디자인입니다! 인간 반응 속도 한계를 시험하는 것이 게임의 목표입니다.
